...
AA_WSCharacter::AA_WSCharacter(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer.SetDefaultSubobjectClass<UClimCharacterMovementComponent>(
...
{
	{
		...
		ADD_INPUT_ACTION(
			JumpAction, "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_Jump.IA_Jump'");
		ADD_INPUT_ACTION(
			MoveAction, "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_Move.IA_Move'");
		ADD_INPUT_ACTION(CrouchAction,
		                 "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_Crouch.IA_Crouch'");
		ADD_INPUT_ACTION(FastRunAction,
		                 "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_FastRun.IA_FastRun'");
		ADD_INPUT_ACTION(
			WalkAction, "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_Walk.IA_Walk'");
		ADD_INPUT_ACTION(
			LookAction, "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_Look.IA_Look'");
		ADD_INPUT_ACTION(PickUpAction,
		                 "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_PickUp.IA_PickUp'");
		ADD_INPUT_ACTION(
			DropAction, "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_Drop.IA_Drop'");
		ADD_INPUT_ACTION(ZoomWheelAction,
		                 "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_ZoomWheel.IA_ZoomWheel'");
		ADD_INPUT_ACTION(
			ClimAction, "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_Climb.IA_Climb'");
		ADD_INPUT_ACTION(CancelClimAction,
		                 "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_CancelClimb.IA_CancelClimb'");
		ADD_INPUT_ACTION(CharacterSwapOneAction,
		                 "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_Character1.IA_Character1'");
		ADD_INPUT_ACTION(CharacterSwapTwoAction,
		                 "/Script/EnhancedInput.InputAction'/Game/ThirdPerson/Input/Actions/IA_Character2.IA_Character2'")
	}
...
float AA_WSCharacter::TakeDamage(float Damage, FDamageEvent const& DamageEvent, AController* EventInstigator,
                                 AActor* DamageCauser)
{
		...
		CustomEvent.IsFirstHit(this))
	{
		if (CharacterStatsComponent->GetHP() > 0)
		{
			...
			UE_LOG(LogTemplateCharacter, Warning, TEXT("TakeDamage! : %s did %f with %s to %s"),
			       *EventInstigator->GetName(), Damage, *DamageCauser->GetName(), *GetName());
...
bool AA_WSCharacter::Take(UC_WSPickUp* InTakenComponent)
{
		...
		LootingBox)
	{
		...
		Inventory->AddItems(LootingItems);
		return true;
	}
		...
		WeaponCast && !RightHandWeapon->GetChildActor())
	{
		...
		RightHandWeapon->GetChildActor()->GetComponentByClass<UMeshComponent>()->
		                 SetCollisionProfileName("ItemEquipped");
	}
...
void AA_WSCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(CancelClimAction, ETriggerEvent::Started, this,
		                                   &AA_WSCharacter::CancelClimb);

		// 캐릭터 변경
		EnhancedInputComponent->BindAction(CharacterSwapOneAction, ETriggerEvent::Started, this,
		                                   &AA_WSCharacter::SwapCharacterOne);
		EnhancedInputComponent->BindAction(CharacterSwapTwoAction, ETriggerEvent::Started, this,
		                                   &AA_WSCharacter::SwapCharacterTwo);
	}
	else
	{
